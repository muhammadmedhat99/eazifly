...
const schema: yup.ObjectSchema<FormData> = yup.object({
    ...
    program_id: yup
        .number()
        .typeError("اختر البرنامج")
        .required("اختر البرنامج"),
...
export const CreateQuestions = () => {
    ...
    const CreateQuestion = useMutation({
        mutationFn: (submitData: FormData) => {
            ...
            return postData("client/report/question/method/store", formdata, myHeaders);
        },
        onSuccess: (data) => {
        ...
        >
            ...
            {typeValue === "multiple_choice" && (
                <>
                    ...
                    />
                    <label className="text-[#272727] font-bold text-sm col-span-2">الاختيارات</label>
                    {fields.map((field, index) => (
                        <div key={field.id} className="grid grid-cols-2 gap-2 border p-2 rounded">
                            <Input
