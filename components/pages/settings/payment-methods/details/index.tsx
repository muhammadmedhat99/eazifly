...
export const PaymentMethodDetails = ({ data }: paymentDetailsProps) => {
    ...
    const { data: paymentData, isLoading } = useQuery({
        queryKey: ['country', id],
        queryFn: async () => await fetchClient(`client/payment/method/show/${id}`, axios_config),
    });
    ...
    return isLoading ? (
        ...
        >
            ...
            <div className="flex items-center justify-between bg-main p-5 rounded-2xl border border-stroke">
                <div className="flex flex-col gap-4">
                    <span className="text-[#5E5E5E] text-sm font-bold">كيفية الاستخدام</span>
                    {editField === "how_to_use" ? (
                        ...
                        <Link
                            href={paymentData?.data?.how_to_use}
