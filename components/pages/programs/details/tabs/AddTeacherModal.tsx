...
const addTeacherSchema = yup.object({
  teachers: yup
    .array()
    .of(
      yup.object().shape({
...
type AddTeacherFormData = yup.InferType<typeof addTeacherSchema>;
...
export default function AddTeacherModal({
  ...
  const defaultValues: AddTeacherFormData = {
  ...
  const assignInstructorsMutation = useMutation({
    mutationFn: (submitData: AddTeacherFormData) => {
  ...
  const { data: instructors, isLoading: instructorsLoading } = useQuery({
    queryFn: async () =>
      await fetchClient(
        `client/program/related/instructors?program_id=${programId}`,
        axios_config
      ),
            ...
            <ModalBody>
              ...
              >
                  ...
                  >
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <Select
                            ...
                            isInvalid={
                              !!errors.teachers?.[index]?.teacher_id?.message
                            }
                            errorMessage={
                              errors.teachers?.[index]?.teacher_id?.message
                            }
                    ...
                    <div className="flex items-start gap-2">
                      <Input
                        ...
                        isInvalid={
                          !!errors.teachers?.[index]?.hour_rate?.message
                        }
                        errorMessage={
                          errors.teachers?.[index]?.hour_rate?.message
                        }
                        ...
                        endContent={
                          <span className="font-semibold text-sm">ج.م</span>
                        }
                      />
                ...
                <div className="flex items-center justify-end gap-4 mt-8">
                  ...
                  >
                    {assignInstructorsMutation?.isPending && (
