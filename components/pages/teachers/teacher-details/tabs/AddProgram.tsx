...
export default function AddProgram({ isOpen, onClose }: StudentModalProps) {
        ...
        {(closeModal) => (
          <>
            ...
            <ModalBody>
              ...
              >
                <div className="grid grid-cols-3 gap-4 mb-6 p-4 border border-gray-200 rounded-lg">
                  {/* Teacher Select */}
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <Select
                          ...
                          errorMessage={errors.program_id?.message?.toString()}
                  ...
                  <div className="flex items-start gap-2">
                    <Input
                      ...
                      errorMessage={errors.amount_per_hour?.message?.toString()}
                      labelPlacement="outside"
                      classNames={{
                        label: "text-[#272727] font-bold text-sm",
