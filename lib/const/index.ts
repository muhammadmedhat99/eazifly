...
export const routes = [
  ...
  },
  {
    ...
    icon: Money2,
    sub_routes: [
      { id: 1, name: "رواتب المعلمين", route: "/instructors/salaries" },
    ],
  },
  {
    id: 6,
  ...
  },
  {
    ...
    sub_routes: [
      ...
      { id: 3, name: "رواتب المعلمين", route: "/instructors/salaries" },
  ...
  },
  {
    ...
    sub_routes: [
      ...
      { id: 6, name: "أسباب تغيير المعلم", route: "/change-instructor" },
      { id: 7, name: "ردود الطلاب", route: "/user-responses" },
      { id: 8, name: "مدة المحاضرات", route: "/sessions-time" },
      { id: 9, name: "كوبونات الخصم", route: "/coupons" },
      { id: 10, name: "الإشعارات", route: "/notifications" },
      { id: 11, name: "طرق التحويل", route: "/transfers" },
    ],
  },
];
